...
class TrackUKF:
    def __init__(self, fps=10):
        ...
        def measurement_function(x):
            # Trạng thái x của bạn: [cx, cy, a, h, vx, vy, omega, vh]
    ...
    def initiate(self, measurement):
        ...
        # Sửa dòng khởi tạo P cho biến thứ 8 (index 7)
        self.ukf.P[4, 4] = self.ukf.P[5, 5] = (10.0 * h) ** 2
        self.ukf.P[6, 6] = 1e-2
        # Tỷ lệ giãn nở ban đầu chưa rõ, cho phép dao động trong khoảng 10%
        self.ukf.P[7, 7] = 1e-2
